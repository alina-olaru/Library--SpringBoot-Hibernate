...
export class DashboardComponent implements OnInit {
  ...
  getBooksAuthorsCategory() {
    return this.dash
      ...
      .subscribe((response: ApiResponse<any[]>) => {
        if (response && response.status == ApiResponseType.SUCCESS) {
          this.AuthorsBooksCategories = response.body;
  ...
  createchartBooksAuthorsCategory() {
    ...
    // Add data
    chart.data = this.AuthorsBooksCategories;
    console.log(chart.data.length + "Date");

    // Add and configure Series
    let pieSeries = chart.series.push(new am4charts.PieSeries());
    pieSeries.dataFields.value = "titleOfCategory";
    pieSeries.dataFields.category = "numberBooksforAuthor";
    ...
    pieSeries2.dataFields.value = "numberBooksforCategory";
    pieSeries2.dataFields.category = "titleOfCategory";
